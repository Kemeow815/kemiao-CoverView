					...
					<div className="flex md:flex-row flex-col  ">
									...
									<div className="bg-white font-Inter  border-dashed border-r-2 border-gray-100 w-full p-4 ">
										<div>
											...
											<div className="m-2 flex flex-col">
												<span className="font-medium text-sm pb-1">封面标题</span>
												<textarea
													type="text"
											...
											<div className="flex flex-col m-2 ">
												<span className="font-medium text-sm pb-1">作者名称</span>
												<input
													type="text"
											...
											<div className="flex flex-col m-2 ">
												<span className="font-medium text-sm pb-1">封面图标</span>
											...
											<div className="flex items-center">
												...
												<div className="flex flex-col m-2 w-1/2">
													<span className="font-medium text-sm pb-1">文本字体</span>
												...
												<div className="flex flex-col m-2 w-1/2">
													<span className="font-medium text-sm pb-1">主题颜色</span>
						...
						<div className="md:w-60 px-4 border-dashed border-l-2 border-gray-100 bg-white">
							<div className="h-99 w-full flex flex-col justify-center">
								...
								<div className="flex items-center">
									<h2 className="text-lg pl-2 font-inter font-semibold">主题选择</h2>
